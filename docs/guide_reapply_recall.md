...
This document lists the required maintenance touchpoints and validation when `recall` behavior changes.

`docs/recall.md` is the canonical semantic contract. Keep this guide focused on maintenance checkpoints instead of restating the full public contract.
