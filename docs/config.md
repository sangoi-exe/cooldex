...
| `tools.context_prune` | boolean | Enable the Smart Prune tool (`context_prune`) that lets the agent list and toggle inclusion of context items non‑destructively (default: true). |
