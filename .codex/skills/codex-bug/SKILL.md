...
<!-- Merge-safety anchor: this workspace-local skill stays scoped to Codex CLI operator bug triage so upstream syncs do not broaden it into unrelated product surfaces. -->
