...
# Merge-safety anchor: fixture coverage distinguishes Cooldex's default GitHub
# releases from the opt-in OpenAI mirror and upstream GitHub fallback.
...
class InstallShTest(unittest.TestCase):
    ...
    def test_releases_latest_installs_verified_package_from_mirror(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            root = Path(temp_dir)
            archive_path, checksum_path, metadata_json = create_package_release(root)
