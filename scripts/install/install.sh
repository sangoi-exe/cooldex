...
# Merge-safety anchor: default installs use Cooldex GitHub Releases; the opt-in
# releases.openai.com route retains upstream GitHub metadata and asset fallback.
...
download_file_with_fallback() {
  ...
  resolve_release_from_github "$resolved_version" "$github_repository"
