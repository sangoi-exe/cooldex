...
// Merge-safety anchor: model-visible Code Mode execution guidance retains bounded
// `Promise.all` orchestration and only documented host globals, not Node/browser APIs.
