...
// Merge-safety anchor: apply_patch CLI suite coverage here is a follower of the same host-local vs
// executor-fs owner split; merges must keep CLI proof aligned with the runtime/library owners.
