...
// Merge-safety anchor: resume/fork comparisons retain durable checkpoint history while
// excluding only transient post-compact handoff and recovery overlay messages.
