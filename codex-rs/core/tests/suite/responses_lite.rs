...
async fn gpt_5_6_family_uses_full_responses_for_turn_and_compaction() -> Result<()> {
    ...
    for model in ["gpt-5.6-sol", "gpt-5.6-terra", "gpt-5.6-luna"] {
            ...
            vec![
                ...
                responses::sse(vec![
                    serde_json::json!({
                        ...
                        "item": {
                            "type": "compaction",
                            "encrypted_content": "GPT_5_6_COMPACT_SUMMARY",
                        }
                    }),
                    responses::ev_completed("resp-compact"),
                ]),
        ...
        let prompt = format!("Compact this {model} conversation");
        ...
        assert_eq!((model, actual), (model, expected));
    }
