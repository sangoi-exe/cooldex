// Merge-safety anchor: phase 2 remains core-local so consolidation can spawn
// through the active Session runtime without adding a codex-core crate cycle.
...
mod job {
    ...
    pub(super) async fn claim(
        ...
        let (token, watermark) = match claim {
            ...
            codex_state::Phase2JobClaimOutcome::SkippedCooldown => return Err("skipped_cooldown"),
