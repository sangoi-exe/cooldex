// Merge-safety anchor: user-shell execution is an operator-requested runtime path; preserve proxy, cancellation, and sandbox-denial semantics across upstream task changes.
