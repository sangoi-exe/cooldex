// Merge-safety anchor: undo is a runtime task surface that mutates visible conversation state; keep cancellation and event emission aligned with local task orchestration.
