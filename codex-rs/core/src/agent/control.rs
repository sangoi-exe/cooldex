...
// Merge-safety anchor: Full-history V2 forks inherit the parent's identity and
// instruction context atomically; this options object must not carry a child hint override.
