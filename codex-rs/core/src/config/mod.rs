...
pub struct Config {
    ...
    // Merge-safety anchor: this runtime-only binding is fixed into new session metadata; it is
    // intentionally not a ConfigToml key because full-history inheritance supplies it at runtime.
