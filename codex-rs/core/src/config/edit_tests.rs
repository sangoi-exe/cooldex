...
// Merge-safety anchor: config edit tests preserve the local config-layer editing contract used by
// workspace overlays and merge-sensitive customization plumbing.
