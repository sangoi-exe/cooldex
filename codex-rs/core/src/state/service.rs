...
pub(crate) struct SessionServices {
    ...
    /// Merge-safety anchor: local recall/manage_context/prompt_gc still need the active
    /// local rollout recorder handle while upstream thread-store owns durable persistence.
