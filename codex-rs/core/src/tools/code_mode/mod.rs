...
impl CodeModeService {
    ...
    pub(crate) async fn start_turn_worker(
        ...
        // Merge-safety anchor: code-mode nested tool calls must keep explicit
        // structured `ToolCallSource::CodeMode` tagging at dispatch time so
        // router/parallel handling preserves source-aware policy/logging.
