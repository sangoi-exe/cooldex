// Merge-safety anchor: apply_patch handler tests are followers of the host-local vs executor-fs
// owner split; merges must keep them aligned with the handler/runtime contract instead of
// reintroducing a blended execution owner here.
