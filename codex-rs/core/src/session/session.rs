...
pub(crate) struct Session {
    ...
    pub(super) agent_last_activity: watch::Sender<Option<CollabAgentActivity>>,
    pub(super) prompt_gc_active: watch::Sender<bool>,
    pub(super) prompt_gc_activity_edges: tokio::sync::broadcast::Sender<PromptGcActivityEdge>,
...
impl SessionConfiguration {
    ...
    pub(super) fn thread_config_snapshot(&self) -> ThreadConfigSnapshot {
        ThreadConfigSnapshot {
            ...
            subagent_file_mutation_mode: self
            ...
            config_path: self
                ...
                .unwrap_or_else(|_| self.codex_home.join(CONFIG_TOML_FILE).to_path_buf()),
    ...
    pub(crate) async fn new(
        ...
        let conversation_id = match &initial_history {
            InitialHistory::New | InitialHistory::Cleared | InitialHistory::Forked(_) => {
                ...
                reserved_thread_id.unwrap_or_default()
            }
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let rollout_recorder = match live_thread_init.as_ref() {
                Some(live_thread) => live_thread.local_rollout_recorder().await?,
                None => None,
            };
            ...
            let (mcp_connection_manager, cancel_token) = McpConnectionManager::new(
                ...
                // Merge-safety anchor: MCP startup must pass the session runtime
