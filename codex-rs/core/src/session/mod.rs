...
impl SteerInputError {
    fn to_error_event(&self) -> ErrorEvent {
        match self {
            ...
            Self::ActiveTurnOutputSchemaMismatch => ErrorEvent {
                misalignment: None,
                message: "active turn uses a different final output schema".to_string(),
                codex_error_info: Some(CodexErrorInfo::BadRequest),
            },
...
impl Session {
    ...
    pub(crate) async fn build_initial_context_with_world_state(
        ...
        self.build_initial_context_with_world_state_for_window(
            turn_context,
            world_state,
        ...
        loop {
            ...
            let (turn_input, client_user_message_id) = match input {
                    ...
                    if matches!(item, ResponseItem::FunctionCallOutput { call_id: None, .. }) =>
                {
                    ...
                    (TurnInput::FunctionCallOutput(item), None)
                }
                _ => {
            ...
            if let Some(incoming_root_turn_id) = incoming_root_turn_id.as_ref()
    ...
    pub(crate) async fn route_user_input(
        ...
        loop {
            ...
            let turn_input = TurnInput::UserInput {
                content: input,
