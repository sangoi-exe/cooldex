// Merge-safety anchor: unified-exec process tracking backs resume/replay and operator-visible execution state; preserve lifecycle accounting during upstream runtime changes.
