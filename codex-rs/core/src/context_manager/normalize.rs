// Merge-safety anchor: normalization must preserve workspace-local synthetic output,
// local-shell pairing, and tool-search/custom-tool canonicalization behavior.
