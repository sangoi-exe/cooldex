...
// Merge-safety anchor: delegate tests pin the local child-agent isolation and event-forwarding
// contract so upstream refactors do not silently reintroduce parent-state leakage.
