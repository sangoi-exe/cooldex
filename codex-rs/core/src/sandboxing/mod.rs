...
Merge-safety anchor: keep this adapter aligned with codex-sandboxing's
SandboxExecRequest contract so the workspace legacy-Landlock override keeps
flowing through transformed exec requests without reviving duplicate owners.
*/
