...
pub(crate) fn build_guardian_review_session_config(
    ...
    // Merge-safety anchor: guardian review sessions must keep the canonical read-only
    // PermissionProfile and the legacy sandbox projection aligned for local exec/request-auth seams.
