// Merge-safety anchor: startup prewarm must keep the workspace-local prompt/tool visibility
// contract aligned with hidden prompt-gc sessions and model-visible tool filtering.
