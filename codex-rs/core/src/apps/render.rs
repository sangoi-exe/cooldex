// Merge-safety anchor: app connector instructions enter the model-visible prompt; keep bounded rendering aligned with local context/prompt customization rules.
