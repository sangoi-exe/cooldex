//! Merge-safety anchor: AGENTS.md discovery and user-instruction assembly are
//! customized seams in this workspace; merge work must preserve the
//! AGENTS/ChildAgentsMd carry-forward for both lead and child sessions while
//! staying structurally close to upstream.
//!
