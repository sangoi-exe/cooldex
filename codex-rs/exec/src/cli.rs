// Merge-safety anchor: `codex exec` is the shipped non-TUI entrypoint; keep CLI args/config plumbing aligned with local auth and sandbox runtime expectations.
