...
pub const DASHBOARD_SERVICE_TYPE_NAME: &str = "aiserver.v1.DashboardService";
...
pub mod dashboard {
    ...
    pub struct GetMeRequest {
        ...
        #[prost(string, optional, tag = "2")]
        pub source_site_hostname: ::core::option::Option<::prost::alloc::string::String>,
        #[prost(bool, optional, tag = "3")]
        pub include_mobile_app_status: ::core::option::Option<bool>,
    }
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
    pub struct GetMeResponse {
        ...
        #[prost(string, optional, tag = "6")]
        pub workos_id: ::core::option::Option<::prost::alloc::string::String>,
    ...
    pub mod dashboard_service_client {
            ...
            <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
        {
            ...
            ) -> std::result::Result<tonic::Response<super::GetMeResponse>, tonic::Status>
            {
                ...
                let codec = tonic_prost::ProstCodec::default();
                let path =
                    http::uri::PathAndQuery::from_static("/aiserver.v1.DashboardService/GetMe");
                let mut req = request.into_request();
                req.extensions_mut()
                    .insert(GrpcMethod::new("aiserver.v1.DashboardService", "GetMe"));
    ...
    pub mod dashboard_service_server {
            ...
            fn call(&mut self, req: http::Request<B>) -> Self::Future {
                match req.uri().path() {
                    "/aiserver.v1.DashboardService/GetMe" => {
                        #[allow(non_camel_case_types)]
                        struct GetMeSvc<T: DashboardService>(pub Arc<T>);
                        impl<T: DashboardService> tonic::server::UnaryService<super::GetMeRequest> for GetMeSvc<T> {
                            ...
                            fn call(
                                ...
                                let inner = Arc::clone(&self.0);
                                let fut = async move {
                                    <T as DashboardService>::get_me(&inner, request).await
                                };
                                Box::pin(fut)
                            }
                        }
        ...
        /// Generated gRPC service name
        pub const SERVICE_NAME: &str = "aiserver.v1.DashboardService";
