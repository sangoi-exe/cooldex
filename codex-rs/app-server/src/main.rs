// Merge-safety anchor: app-server startup wiring is a shipped CLI/runtime seam; preserve local config/auth/runtime option propagation when upstream transport changes land.
