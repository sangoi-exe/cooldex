// Merge-safety anchor: remote-control protocol URLs are serialized app-server contracts; preserve workspace enrollment/status semantics across upstream transport churn.
