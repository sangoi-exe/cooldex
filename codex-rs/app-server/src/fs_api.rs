// Merge-safety anchor: app-server filesystem RPCs are a CLI-visible remote surface; keep request/response behavior aligned with the workspace app-server protocol customizations.
