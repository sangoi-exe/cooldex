...
#[test_case(
    ...
    "does not inherit parent developer instructions without a child override"
)]
#[test_case(
...
async fn cold_resume_preserves_effective_developer_instructions_for_worker(
    ...
    expected_developer_instructions: Option<&str>,
...
"#
    ...
    let expected_reasoning_effort = baseline
        .reasoning_effort
        .clone()
        .expect("initial worker reasoning effort");
