    ...
    let result = timeout(
        ...
        run_main_with_transport_options(
            ...
            AppServerRuntimeOptions {
                ...
                // Merge-safety anchor: remote-control requirements exercise the direct app-server path; instance-child remains TUI-only.
                launch_mode: codex_app_server::AppServerLaunchMode::Direct,
                ..Default::default()
            },
        ),
    )
