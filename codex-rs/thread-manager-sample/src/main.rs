...
use codex_core_api::AgentUsageHintBinding;
...
fn new_config(model: Option<String>, arg0_paths: Arg0DispatchPaths) -> anyhow::Result<Config> {
    ...
    let mut config = Config {
        ...
        compact_prompt: None,
        post_compact_recovery_instructions: None,
        notify: None,
        ...
        // Merge-safety anchor: embedding-created threads use ordinary hint resolution;
        // full-history binding is supplied by the agent identity owner.
