...
fn new_config(model: Option<String>, arg0_paths: Arg0DispatchPaths) -> anyhow::Result<Config> {
    ...
    Ok(Config {
        ...
        compact_prompt: None,
        post_compact_recovery_warning: None,
        ...
        tui_resume_history: Default::default(),
        ...
        recall_kbytes_limit: 256,
        recall_debug: None,
        agent_max_threads: Some(6),
        agent_allow_running_subagent_preemption: true,
        agent_job_max_runtime_seconds: None,
        manage_context_policy: Default::default(),
