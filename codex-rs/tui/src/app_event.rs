...
// Merge-safety anchor: TUI app events keep account-add completion routing and rate-limit refresh
// origin/account-generation routing as separate owners; merges must not collapse one enum into the
// other.
#[derive(Debug)]
...
pub(crate) enum AppEvent {
    ...
    /// aligned with `AccountManager::list_accounts()` fields rendered by account popups.
