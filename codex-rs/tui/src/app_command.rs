...
impl AppCommand {
    ...
    pub(crate) fn into_core(self) -> Op {
        match self {
            ...
            Self::StopBackgroundTerminals => Op::StopBackgroundTerminals,
            ...
            Self::DynamicToolResponse { id, response } => Op::DynamicToolResponse { id, response },
            Self::RequestPermissionsResponse { id, response } => {
    ...
    pub(crate) fn view(&self) -> AppCommandView<'_> {
        match self {
            ...
            Self::StopBackgroundTerminals => AppCommandView::StopBackgroundTerminals,
            Self::RealtimeConversationStart(params) => {
            ...
            Self::DynamicToolResponse { id, response } => {
...
impl From<Op> for AppCommand {
    fn from(value: Op) -> Self {
        match value {
            ...
            Op::StopBackgroundTerminals => Self::StopBackgroundTerminals,
            ...
            Op::DynamicToolResponse { id, response } => Self::DynamicToolResponse { id, response },
            Op::RequestPermissionsResponse { id, response } => {
                Self::RequestPermissionsResponse { id, response }
            }
