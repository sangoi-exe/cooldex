// Merge-safety anchor: resume picker is an operator-facing history surface; keep thread list filters, cwd display, and rollout-backed resume metadata aligned.
