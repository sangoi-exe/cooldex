...
// Merge-safety anchor: V2 child rollout headers persist their Resolve binding at birth while V1
// headers retain their unbound shape for the distinct capability path.
#[test]
                ...
                let thread_settings = EventMsg::ThreadSettingsApplied(
                    codex_protocol::protocol::ThreadSettingsAppliedEvent {
                        ...
                        thread_settings: codex_protocol::protocol::ThreadSettingsSnapshot {
                            ...
                            runtime_workspace_roots: Some(app.config.workspace_roots.clone()),
