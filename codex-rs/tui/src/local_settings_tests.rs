...
"#,
        ...
        if !config_text.is_empty() {
            ...
            // Merge-safety anchor: Cover the fork-owned app-server mode projection with its non-default resolved value.
            expected.app_server_mode = AppServerMode::InstanceChild;
        }
