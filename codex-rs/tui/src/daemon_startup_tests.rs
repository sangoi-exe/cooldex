...
//! Merge-safety anchor: only implicit daemon targets may fall back, while startup consistently
//! returns the ownership-aware AppServerSession for every target mode.
