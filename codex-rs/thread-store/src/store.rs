// Merge-safety anchor: ThreadStore is the persistence trait behind resume/fork/list flows; keep method contracts aligned with rollout-backed history ownership.
