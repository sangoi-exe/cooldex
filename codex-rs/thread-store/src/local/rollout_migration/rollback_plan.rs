...
// Merge-safety anchor: local post-compaction recovery proofs stay neutral while retained answers
// retain their upstream call-boundary ownership through rollback and checkpoint trimming.
