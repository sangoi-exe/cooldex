...
// Merge-safety anchor: migration fixtures preserve local recovery records together with upstream
// persisted compaction and retained-answer rollback behavior.
