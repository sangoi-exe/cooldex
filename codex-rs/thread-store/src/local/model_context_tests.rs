...
async fn replays_nested_archived_lineage_with_compressed_ancestor() {
    ...
    for path in [&middle_path, &child_path] {
...
// Merge-safety anchor: model-context fixtures keep compressed archived lineage, recovery-aware
// checkpoints, and canonical frozen-offset decoding aligned with persisted rollout evolution.
