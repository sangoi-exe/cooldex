// Merge-safety anchor: spawn_agents_on_csv tool-schema tests must keep max_concurrency as the only public concurrency field for the legacy agent-job surface.
