// Merge-safety anchor: PID/start-identity records gate stale cleanup and signaling;
// Unix direct-child reaping remains covered by the Unix-only stop test below.
