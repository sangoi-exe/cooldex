...
//!
//! Merge-safety anchor: runtime log persistence is operator/debug-visible state; keep bounded logging and SQLite ownership aligned with local state DB invariants.
//!
