// Merge-safety anchor: StateRuntime coordinates local thread/account/job metadata; preserve SQLite owner boundaries used by resume and account coordination.
