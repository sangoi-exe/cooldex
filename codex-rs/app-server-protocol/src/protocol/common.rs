...
// Merge-safety anchor: shared protocol types here must stay aligned with workspace-local auth,
// collab, and approval surface customizations across Rust and generated schemas.
