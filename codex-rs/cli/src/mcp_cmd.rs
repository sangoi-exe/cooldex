// Merge-safety anchor: MCP CLI management is an operator-facing config/OAuth seam; keep env-source and auth mutations routed through the canonical MCP owners.
