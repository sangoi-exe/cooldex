...
// Merge-safety anchor: env-source typed exports are the public config contract
// for remote-aware MCP stdio routing; do not collapse them back to raw strings.
pub use mcp_types::McpServerEnvVar;
pub use mcp_types::McpServerEnvVarSource;
