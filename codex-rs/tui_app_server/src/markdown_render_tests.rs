...
// Merge-safety anchor: markdown render snapshots are a merge seam for local operator-facing TUI
// output and must stay explicit when upstream rendering behavior shifts.
